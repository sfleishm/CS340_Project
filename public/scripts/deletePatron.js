document.addEventListener('DOMContentLoaded', DeletePatron)
...
function DeletePatron() {
    document.querySelector('#tableID').onclick = async (event) => {
        var patronID = event.target.parentNode.parentNode.firstChild.nextSibling.innerHTML
        console.log(patronID)

        var req = new XMLHttpRequest();
        var submit = 'Genre'
        var payload = { patronID: patronID }
